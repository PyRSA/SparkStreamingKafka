 ...
 */
public final class KafkaOffsetSaveToHBase {
            ...
            try {
                ...
                for (Result r : rs) {
                    ...
                    for (Cell cell : r.rawCells()) {
                        if (new String(CellUtil.cloneValue(cell)).equals("topic"))
                        {
                            ...
                            System.out.println("列族:" + cf + " 列:" + cl + ":" + s1);
                        }

                        if (new String(CellUtil.cloneValue(cell)).equals("partition"))
                        {
                            s2 = Bytes.toInt(cell.getValueArray(), cell.getValueOffset(), cell.getValueLength());
                            String cf = Bytes.toString(cell.getFamilyArray(), cell.getFamilyOffset(), cell.getFamilyLength());
                            String cl = Bytes.toString(cell.getQualifierArray(), cell.getQualifierOffset(), cell.getQualifierLength());
                            System.out.println("列族:" + cf + " 列:" + cl + ":" + s2);
                        }

                        if (new String(CellUtil.cloneValue(cell)).equals("offset"))
                        {
                            s3 = Bytes.toLong(cell.getValueArray(), cell.getValueOffset(), cell.getValueLength());
                            String cf = Bytes.toString(cell.getFamilyArray(), cell.getFamilyOffset(), cell.getFamilyLength());
                            String cl = Bytes.toString(cell.getQualifierArray(), cell.getQualifierOffset(), cell.getQualifierLength());
                            System.out.println("列族:" + cf + " 列:" + cl + ":" + s3);
                        }
                    }
